# Public Key
Represents a TACHACOIN public key and is needed to be able to receive TACHACOIN, as is usually represented as a TACHACOIN [Address](address.md). 

A PublicKey in tachacoincore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = tachacoincore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new tachacoincore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = tachacoincore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
