# Private Key
Represents a TACHACOIN private key and is needed to be able to spend TACHACOIN and sign transactions.
...
Note: The WIF (Wallet Import Format) includes information about the network and if the associated public key is compressed or uncompressed (thus the same TACHACOIN address will be generated by using this format).
